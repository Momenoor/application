                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                <th class="min-w-50px">{{ __('app.id') }}</th>
                                <th class="min-w-150px">{{ __('app.user') }}</th>
                                <th class="min-w-125px">{{ __('app.joined_date') }}</th>
                                <th class="text-end min-w-100px">{{ __('app.actions') }}</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="#" class="btn btn-sm btn-light btn-active-light-primary"
                                                ...
                                                data-kt-menu-placement="bottom-end">{{ __('app.actions') }}
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/seven-html-pro/?page=apps/user-management/users/view"
                                                        class="menu-link px-3">{{ __('app.view') }}</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3"
                                                        data-kt-roles-table-filter="delete_row">{{ __('app.delete') }}</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
