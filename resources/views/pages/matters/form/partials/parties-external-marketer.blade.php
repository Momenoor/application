...
@if ($hasExternalCommission)
    <div class="col-6">
        ...
        <!--end::Label-->
        <!--begin::Select-->
        <select id="externalMarketer" data-placeholder="Select Marketer" wire:model="otherParties.external_markter.id"
            data-control="select2"
            class="@error('otherParties.external_markter.id') is-invalid @enderror form-select form-select-solid"
        ...
        @error('otherParties.external_markter.id')
