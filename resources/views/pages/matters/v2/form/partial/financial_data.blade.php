<div class="col-12">
    <div class="mb-10 row">
        <div class="col-5  mb-5 fv-plugins-bootstrap5-row-invalid">
            <label for="claimAmount" class="required form-label">{{ __('app.amount') }}</label>
            <div class="input-group input-group-solid">
                <input id="claimAmount" type="text"
        ...
        <div class="col-4 mb-5">
            <label for="claimType" class="required form-label">{{ __('app.type') }}</label>
            <select id="claimType" class="form-select @error('claim.type') is-invalid @enderror form-select-solid"
                    data-hide-search="true" data-control="select2" data-placeholder="{{__('app.select_a_type')}}">
                <option></option>
        ...
        <div class="col-3">
            <label for="claimRecurring" class="required form-label">{{ __('app.recurring') }}</label>
            <select id="claimRecurring" data-hide-search="true" data-control="select2"
        ...
        <div class="d-flex flex-stack">
            <div>
                <label
                    ...
                    <input class="form-check-input" id="claimTaxable" type="checkbox">
                </label>
            </div>
            <div>
