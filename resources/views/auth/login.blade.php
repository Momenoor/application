        ...
        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" method="POST" novalidate="novalidate" id="sign_in_form"
                ...
                <div class="text-center mb-10">
                    <!--begin::Title-->
                    <h1 class="text-dark mb-3">{{ __('login to ') . config('app.name') }}</h1>
                    <!--end::Title-->
                    <!--begin::Link-->
                    <div class="text-gray-400 fw-bold fs-4">{{ __('new here ?') }}
                        <a href="{{ route('register') }}"
                            class="link-primary fw-bolder">{{ __('register new account') }}</a>
                    </div>
                    <!--end::Link-->
                </div>
                <!--begin::Heading-->
                ...
                <div class="fv-row mb-10">
                    <!--begin::Label-->
                    <label class="form-label fs-6 fw-bolder text-dark">{{ __('username or email') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input
